...
const handlesubmit=(e)=>{
    e.prevantdefault()
    axios.put(`https://demo-backend-9cij.onrender.com/Product/${id}`,formdata).then((res)=>{console.log(formdata)
    alert("data updated!!")}).catch((err)=>console.log(err))
}
const getfundata=()=>{
    axios.get(`https://demo-backend-9cij.onrender.com/Product/${id}`).then((res)=>{setformdata(res.data)
